...
<html lang="en"><head><meta charset="utf-8"><title>If SABL moves to Robinhood Chain</title>
...
<body>
<div class="head"><span><b>PRIME CIRCLE</b>&nbsp;&nbsp;Sable Observatory · independent</span><span>sable.primecircle.cloud · 12 Sep 2026</span></div>
<div class="eyebrow">Analysis · the migration to Robinhood Chain</div>
${body}
...
const foot =`<div style="width:100%;font-family:'IBM Plex Mono',Consolas,monospace;font-size:7.5pt;color:#5B6B78;padding:0 16mm;display:flex;justify-content:space-between;">
  <span>SABL moves to Robinhood Chain: a migration blueprint · independent analysis · the author holds SABL · 12 Sep 2026</span><span>page <span class="pageNumber"></span> of <span class="totalPages"></span></span></div>`;
