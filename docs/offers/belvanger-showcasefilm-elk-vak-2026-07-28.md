...
> **Bijgewerkt 2026-08-07: er is een achtste vak bij gekomen** — glaszetter
> (`voorbeelden/glaszetter-premium.html`, azuur `#0F5FA8`). De film hieronder toont zeven
> vakken en dat klopt voor de opname van 28 juli. Hermonteer je hem ooit, neem dan de
> achtste mee: het opnamescript loopt over de map, dus de pagina wordt vanzelf gevonden,
> maar de tekstkaart met de vakken bij naam en de tijdlijn hieronder moeten met de hand
> bij. Er is voorlopig **geen reden** om te hermonteren — er ligt geen betalende klant, en
> een derde filmronde is precies het uitstelgedrag dat onderaan dit document staat.
