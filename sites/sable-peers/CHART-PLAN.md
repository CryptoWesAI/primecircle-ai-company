...
## The window (9 September 2026, founder's report)

On day candles the 7d view lost the 2 September event: the window began at the first full day candle (3 September), while the hour view began at 2 September 09:00. Now the window is measured back from now and every candle that overlaps it is shown, so 7d on day candles is eight candles including today's partial one, hour 7d is 169, and 24h on 5-minute candles is 289. Events are still filtered to the candles on screen. The test fixture puts candles on their real grid (days at 00:00 UTC) and asserts the 2, 4 and 8 September events on day 7d. `window.__SABLE_NOW` lets the tests pin "now".
