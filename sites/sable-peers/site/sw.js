...
const VERSION = "sable-sw-2026-09-08a";
const SHELL = ["/", "/index.html", "/app.js", "/manifest.webmanifest", "/icons/icon-192.png", "/robot.png", "/sable-mark.svg"];
const SHELL_PATH = /^\/(index\.html|app\.js|manifest\.webmanifest|robot\.png|sable-mark\.svg|lisa\.js|winner\.html|winner\.js|game\/[a-z]+\.js|icons\/.+|fonts\/.+)?$/;
